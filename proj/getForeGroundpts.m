function [ FG_pts , obj_num,depthArrayFG1,depthArrayFG2,frame_obj] = getForeGroundpts( backGround_a,backGround_b,deptharray1,deptharray2,im1,im2 )
...
%      
 ...
 goodLabels2(find(max(labelCounts2(:,2))))=[];
  ...
  frame_obj=zeros(480,640,length(goodLabels1));
  for i=1:length(goodLabels1)
  goodItems1=goodItems1 | bw1==goodLabels1(i);
  frame_obj(:,:,i) =  bw1==goodLabels1(i);
  end
%figure
%imagesc(goodItems1);
