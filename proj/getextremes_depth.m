...
%   Detailed explanation goes here
    ...
    while( n(idx(j)) > 3E3) % por todos os conjuntos com mais de 3000 pixeis (1% de uma imagens), pode/deve ser modificado para outro valor


        %guarda nas variáveis de ouput o conjunto linhas/colunas que pertecen à label que está a ser analisada agora
        [r, c] = find(TEMP==(idx(j)-1));%procura todos os pixeis que pertencem ao conjunto que presentemente está a ser analisado
